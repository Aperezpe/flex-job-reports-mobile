...
export const fetchClientsSuccess = createAction<ClientAndAddresses[]>('FETCH_CLIENTS_SUCCESS');
...
export const addClientSuccess = createAction<ClientAndAddresses>('ADD_CLIENT_SUCCESS');
