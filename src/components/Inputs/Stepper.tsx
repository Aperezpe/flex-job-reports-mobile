  ...
  return (
    <View style={[globalStyles.row, styles.container]}>
      ...
      <View style={globalStyles.row}>
        <TouchableOpacity style={[styles.button, styles.buttonMinus]} onPress={() => handleChange(-.5)}>
          <Entypo name="minus" size={18} />
        </TouchableOpacity>
        <Text style={styles.value}>{value.toFixed(1).toString()}</Text>
        <TouchableOpacity style={[styles.button, styles.buttonPlus]} onPress={() => handleChange(+.5)}>
