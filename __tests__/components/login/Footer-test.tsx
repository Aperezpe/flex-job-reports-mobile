...
import * as AuthScreencontext from "../../../context/AuthScreen.ctx";
import Footer from "../../../components/login/Footer";

const setMockState = (state: Partial<typeof AuthScreencontext.defaultAuthScreenContext>) => {
  (AuthScreencontext.useAuthScreenContext as jest.Mock).mockReturnValue({
    ...AuthScreencontext.defaultAuthScreenContext,
    ...state,
  });
};
...
describe("<Footer />", () => {
  ...
  beforeEach(() => {
    setMockState(AuthScreencontext.defaultAuthScreenContext);
  });
